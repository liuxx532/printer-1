...
public class FingerActivity extends Activity implements OnClickListener {
	...
	public void InitWidget() {
		...
		if (m_usbComm == null) {
			m_usbComm = new DevComm(device, baudrate);
		}
	...
	/**
	 * check the ID is correct or incorrectness
	 * @return true correct;false incorrectness
	 */
	...
	/**
	 * Capturing the image of fingerprint
